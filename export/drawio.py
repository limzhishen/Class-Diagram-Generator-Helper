...
class drawio_export(Export):
    ...
    def process(self,line):
        ...
        if self.duplicateStatus:
            self.logging.debug_red("Duplicate Class: "+self.filename+"  "+self.name)
            self.add_one_subtext("Duplicate class name: "+self.filename+" "+self.name,id)
        if self.extend_duplicate:
            self.logging.debug_red("extend Class: "+self.filename+"  "+self.name)
            self.add_one_subtext("Extended Duplicate class name: "+self.filename+" "+self.name ,id)
